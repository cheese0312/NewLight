...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/kakaoTheme.css" />
  </head>
  <body>
    <header>
        ...
        <div class="category-create-container">
          <div class="category-name">
            <a href="" class="category-name-theme"
                >카카오톡 테마
                <img src="../img/kakao-talk.png" alt="" class="category-name-img" />
          </div>
          <ul class="create-list">
            <div class="create-card">
              <div class="create-logo">
                <a href="${pageContext.request.contextPath}/board/themeDownload.jsp">
            ...
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg02.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">
            ...
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg03.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">
          ...
          <ul class="create-list">
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg04.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">
            ...
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg05.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">
            ...
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg06.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">
          ...
          <ul class="create-list">
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg07.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">
            ...
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg08.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">
            ...
            <div class="create-card">
              <a href="#">
                <img src="../img/kakaothemeImg09.png" alt="" class="create-card-img" />
              </a>
              <div class="create-title">
                <h4>제목</h4>
                <div class="create-people">

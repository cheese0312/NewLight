...
<body>
	...
	<form action="${pageContext.request.contextPath}/mypage/mypageEditOk.me"
				...
				<div class="info-menu">
					<form
						...
						<fieldset>
							...
							<div class="info-name">
								<label for="id-change">이름 </label> <input type="text" name="memberName"
									id="id-chnage" required value="${memberDTO.getMemberName()}" readonly/>
							</div>
							<div class="info-id">
								<label for="id-change">아이디 </label> <input type="text" name="memberId"
							...
							<div class="info-phone">
								<label for="id-change">핸드폰 번호 </label> <input type="text" name="memberPhoneNumber"
							...
							<div class="info-website">
								<label for="website-change">웹 사이트</label> <input type="text"
									name="memberWebsite" id="web-change" placeholder="http://" required />
							</div>
	...
	<script src="${pageContext.request.contextPath}/assets/js/member/information.js"></script>
</body>
</html>

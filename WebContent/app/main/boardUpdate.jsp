...
<body>
	<div class="container">
		...
		<form id="write-form" action="${pageContext.request.contextPath}/creations/CreationUploadOk.ct" method="post"
			...
			<div class="form-group">
				...
				<input type="text" id="title" name="creationTitle" value="${creation.getCreationTitle()}" required />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea id="content" name="creationContent" required><c:out value="${creation.getCreationContent()}"/></textarea>
			</div>
			<div class="form-group">
				<label for="file">파일 첨부</label>
				<div class="image-upload-wrap">
					<input type="file" id="file" name="creationFile"
	...
	<script
		src="${pagetContext.request.contextPath}/assets/js/boardUpdate.js"></script>
</body>
</html>

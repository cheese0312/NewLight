...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/community/communityUpdateOk.cm"
		method="post" enctype="multipart/form-data">

		<input type="hidden" name="communityNumber"
			value="${community.getCommunityNumber()}">
		...
		<section>
			...
			<div class="small-box">
				...
				<input type="text" class="title" name="communityTitle"
					value="${community.getCommunityTitle()}" required /> <br> <br>
				<div class="word1">
					<p>내용</p>
				</div>
				<textarea type="text" class="word" name="communityContent"><c:out
						value="${community.getCommunityContent()}" /></textarea>
			</div>
			<br> <br>

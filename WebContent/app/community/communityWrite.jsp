...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/community/communityWriteOk.cm"
		...
		<section>
				...
				<div class="gd">
					...
					<div class="small-box">
						...
						<input type="text" class="title" name="communityTitle" autofocus="autofocus"> <br>
						<br>
						<div class="word1">
							<p>내용</p>
						</div>
					...
					<div class="form-group">
						...
						<div class="image-upload-wrap">
							<input type="file" id="file" name="communityFile"
								accept=".jpg, .jpeg, .png" multiple />
							<div class="image-upload-box color">
								<div class="upload-text color">
									...
									<div class="upload-count color">
										이미지 업로드(<span class="cnt">0</span>/5)
									</div>
								</div>
								<div class="upload-text color">최대 5개까지 업로드 가능</div>
								<div class="upload-text color">파일 형식 : jpg, png</div>
								<div class="upload-text color">※ 이미지를 등록하면 즉시 반영됩니다.</div>
							</div>
						</div>
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/community/communityWrite.js"></script>
</body>
</html>